...
values."
  ...
  (setq-default
   ...
   ;; Load last saved layout on startup
...
you should place your code here."
  ...
  (setq projectile-project-compilation-cmd "build")
  ;;(setq projectile-project-compilation-dir "/code")
  ...
  ;;              '("*compilation*" :dedicated t :position right :stick t :noselect t))
